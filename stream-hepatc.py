...
if menu == "Home":
    ...
    st.image('heading.jpg', use_column_width=True)
    ...
    with st.expander("Logistic Regression"):
        st.image('logisticregression.jpg',use_column_width=True)
    ...
    with st.expander("Decision Tree"):
        st.image('decisiontree.png', use_column_width=True)
    ...
    with st.expander("Random Forest"):
        st.image('srandomforest.png', use_column_width=True)
    ...
    with st.expander("K-Nearest Neighbors"):
        st.image('knn.jpg',use_column_width=True)
    ...
    with st.expander("CatBoost"):
        st.image('catboost.jpg',use_column_width=True)
    ...
    with st.expander("Gradient Boosting"):
        st.image('gradientboosting.png',use_column_width=True)
